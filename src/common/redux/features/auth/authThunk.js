...
import { AUTH_FORGOT, AUTH_LOGIN, AUTH_REGISTRATION, AUTH_USER_BY_TOKEN } from "../../../constants/ApiLink";
import RequestServices from "../../services/request-services";
import { setUser } from "../User/userSlice";

/** Auth Login */
export const login = createAsyncThunk("auth/login", async ({ userData, history }, thunkApi) => {
  try {
...
/** Auth Registration */
export const register = createAsyncThunk("auth/register", async (userRegistration, thunkApi) => {
  try {
    await RequestServices.post(AUTH_REGISTRATION, userRegistration);
  } catch (error) {
