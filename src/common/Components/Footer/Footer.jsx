            ...
            <div className="content">
              <div className="content__main">
                <div className="content__main___col">
                  ...
                  <p className="name">Công ty cổ phần Super Shipping Việt Nam</p>
                  <ul className="link">
                    <li className="link__item address">
                      Tòa nhà Lữ Gia, Tầng 4 - 70 Lữ Gia - F.15 - Q11 - Tp. Hồ Chí
                      Minh
                    </li>
                ...
                <div className="content__main___col">
                  ...
                  <ul className="main">
                    <li className="main__item">Dịch vụ và Điều khoản của bạn</li>
