...
export default function ProductDetail() {
  ...
  return (
    <>
      {
        dataProductDetail && dataProductDetail[0] ? <>
            ...
            <div className="container">
              <div className="detail__content breadcrumb">
                ...
                <div className="detail__content___product">
                  {
                    !loadingProductDetail && dataProductDetail ?
                      <ProductDetailRoot /> : <LoadingSpinner css={{ width: "100%", textAlign: "center" }} />
                  }
                </div>
