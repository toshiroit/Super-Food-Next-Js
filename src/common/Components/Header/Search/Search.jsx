...
import { hideDisplay, showDisplay } from "../../../redux/features/showDisplay/showSearchDisplaySlice";
import SearchList from "./SearchList/SearchList";

export default function Search() {
  /* Get isDisplaySeach Redux */
  const isDisplaySearchList = useSelector(state => state.showSearchDisplaySlice)
  ...
  return (
    <form onSubmit={onSearchSubmit} ref={refInputSearch} id="searchList" method="">
      <div className="search">
        ...
        {
          isDisplaySearchList.display ? <SearchList nameSearch={search} refInputSearch={refInputSearch} /> : ""
        }
      </div>
    </form>
